...
public class RenderItemFrame extends Render
{
    ...
    private void func_147915_b(EntityItemFrame p_147915_1_)
    {
        ...
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F - var5 + 0.0625F, 0.5F - var5 + 0.0625F, var3, 0.5F + var5 - 0.0625F, 0.5F + var5 - 0.0625F);
        ...
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F - var5, 0.5F - var5, var3 + 1.0E-4F, var3 + 0.5F - var5, 0.5F + var5);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F + var5 - var3, 0.5F - var5, var3 + 1.0E-4F, 0.5F + var5, 0.5F + var5);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F - var5, 0.5F - var5, var3, 0.5F + var5, var3 + 0.5F - var5);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F - var5, 0.5F + var5 - var3, var3, 0.5F + var5, 0.5F + var5);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        GL11.glPopMatrix();
        this.field_147916_f.unlockBlockBounds();
        this.field_147916_f.clearOverrideBlockTexture();
    ...
    private void renderFrameItemAsBlock(EntityItemFrame par1EntityItemFrame)
    {
        ...
        float var5 = var4 / 2.0F;
        GL11.glPushMatrix();
        this.field_147916_f.overrideBlockBounds(0.0D, 0.5F - var5 + 0.0625F, 0.5F - var5 + 0.0625F, var3 * 0.5F, 0.5F + var5 - 0.0625F, 0.5F + var5 - 0.0625F);
        this.field_147916_f.setOverrideBlockTexture(this.field_94147_f);
        this.field_147916_f.renderBlockAsItem(var2, 0, 1.0F);
        this.field_147916_f.clearOverrideBlockTexture();
        this.field_147916_f.unlockBlockBounds();
            ...
            } else
            {
                if (var4 == Items.compass)
                {
                    ...
                    if (var141 instanceof TextureCompass)
                    {
                        ...
                        var151.updateCompass(par1EntityItemFrame.worldObj, par1EntityItemFrame.posX, par1EntityItemFrame.posZ, MathHelper.wrapAngleTo180_float((float) (180 + par1EntityItemFrame.hangingDirection * 90)), false, true);
