...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (!this.mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            this.drawTexturedModalRect(width / 2 - 91 - 1 + Nebula.INVENTORY.slot() * 20, height - 22 - 1, 0, 22, 24, 22);
    ...
    private void renderCustomDebug(int width)
    {
        ...
        font.drawStringWithShadow("TPS: " + Nebula.SERVER.averageTPS() + " [" + Nebula.SERVER.tps() + "]", 2, y += 10, color);
