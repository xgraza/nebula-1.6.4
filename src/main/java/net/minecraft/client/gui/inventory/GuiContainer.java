...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (var16 != null)
        {
            ...
            this.drawItemStack(var16, par1 - var4 - var17, par2 - var5 - var11, var12);
        }
    ...
    private void drawItemStack(ItemStack p_146982_1_, int p_146982_2_, int p_146982_3_, String p_146982_4_)
    {
        ...
        RENDER_ITEM.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), p_146982_1_, p_146982_2_, p_146982_3_);
        RENDER_ITEM.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.getTextureManager(), p_146982_1_, p_146982_2_, p_146982_3_ - (this.field_147012_x == null ? 0 : 8), p_146982_4_);
        this.zLevel = 0.0F;
    ...
    {
        int posX = slot.xDisplayPosition;
        int posY = slot.yDisplayPosition;
        ...
        if (slot == this.field_147005_v && this.field_147012_x != null && this.field_147004_w && itemStack != null)
        {
        ...
        if (itemStack == null)
        {
            ...
            if (var9 != null)
            {
                ...
                this.drawTexturedModelRectFromIcon(posX, posY, var9, 16, 16);
                GL11.glEnable(GL11.GL_LIGHTING);
                var6 = true;
            }
        }
        ...
        if (!var6)
        {
            ...
            GL11.glEnable(GL11.GL_DEPTH_TEST);
            RENDER_ITEM.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.getTextureManager(), itemStack, posX, posY);
            RENDER_ITEM.renderItemOverlayIntoGUI(this.fontRenderer, this.mc.getTextureManager(), itemStack, posX, posY, var8);
        }
    ...
    protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_)
    {
        ...
        if (this.field_146993_M && var4 != null && p_146286_3_ == 0 && this.container.func_94530_a(null, var4))
        {
            if (isShiftKeyDown())
            {
    ...
    protected boolean func_146983_a(int p_146983_1_)
    {
        if (this.mc.thePlayer.inventory.getItemStack() == null && this.theSlot != null)
        {
            ...
            {
                if (p_146983_1_ == this.mc.gameSettings.keyBindsHotbar[slot].getKeyCode())
                {
                    this.func_146984_a(this.theSlot, this.theSlot.slotNumber, slot, 2);
                    return true;
                }
            }
        }
