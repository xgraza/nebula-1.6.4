...
public class PositionedSoundRecord extends PositionedSound
{
    ...
    {
        return new PositionedSoundRecord(p_147674_0_, 0.25F, p_147674_1_, false, 0, AttenuationType.NONE, 0.0F, 0.0F, 0.0F);
    }

    public static PositionedSoundRecord func_147673_a(ResourceLocation p_147673_0_)
    {
        return new PositionedSoundRecord(p_147673_0_, 1.0F, 1.0F, false, 0, AttenuationType.NONE, 0.0F, 0.0F, 0.0F);
    }
    ...
    {
        return new PositionedSoundRecord(p_147675_0_, 4.0F, 1.0F, false, 0, AttenuationType.LINEAR, p_147675_1_, p_147675_2_, p_147675_3_);
    }
    ...
    {
        this(p_i45107_1_, p_i45107_2_, p_i45107_3_, false, 0, AttenuationType.LINEAR, p_i45107_4_, p_i45107_5_, p_i45107_6_);
    }

    private PositionedSoundRecord(ResourceLocation p_i45108_1_, float p_i45108_2_, float p_i45108_3_, boolean p_i45108_4_, int p_i45108_5_, AttenuationType p_i45108_6_, float p_i45108_7_, float p_i45108_8_, float p_i45108_9_)
    {
        super(p_i45108_1_);
