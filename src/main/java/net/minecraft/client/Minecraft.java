...
import us.nebula.impl.cheat.render.UnfocusedCPUCheat;
...
public class Minecraft
{
    ...
    {
        final String[] properties = new String[]{ "sun.arch.data.model", "com.ibm.vm.bitmode", "os.arch" };
        for (final String location : properties)
        {
            final String value = System.getProperty(location);
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                {
                    EventBus.dispatch(new EventMouse(var1));
            ...
            while (Keyboard.next())
            {
                ...
                {
                    EventBus.dispatch(new EventKey(k));
                    KeyBinding.onTick(k);
                }
