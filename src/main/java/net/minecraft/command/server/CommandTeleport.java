        ...
        } else
        {
            ...
            if (par2ArrayOfStr.length != 3 && par2ArrayOfStr.length != 4)
            {
                if (par2ArrayOfStr.length == 1 || par2ArrayOfStr.length == 2)
                {
                    ...
                    notifyAdmins(par1ICommandSender, "commands.tp.success", var3.getCommandSenderName(), var11.getCommandSenderName());
                }
            } else if (var3.worldObj != null)
            {
                ...
                notifyAdmins(par1ICommandSender, "commands.tp.success.coordinates", var3.getCommandSenderName(), Double.valueOf(var5), Double.valueOf(var7), Double.valueOf(var9));
            }
        }
    }
