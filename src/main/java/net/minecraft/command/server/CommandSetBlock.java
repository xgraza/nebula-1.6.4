...
public class CommandSetBlock extends CommandBase
{
        ...
        if (par2ArrayOfStr.length >= 4)
        {
            ...
            } else
            {
                ...
                } else
                {
                    ...
                    notifyAdmins(par1ICommandSender, "commands.setblock.success");
                }
            }
        } else
        {
    ...
    {
        return par2ArrayOfStr.length == 4 ? getListOfStringsFromIterableMatchingLastWord(par2ArrayOfStr, Block.blockRegistry.getKeys()) : (par2ArrayOfStr.length == 6 ? getListOfStringsMatchingLastWord(par2ArrayOfStr, "replace", "destroy", "keep") : null);
    }
}
