...
public class ItemArmor extends Item
{
    ...
    {
        return this.material == ArmorMaterial.CLOTH && (par1ItemStack.hasTagCompound() && (par1ItemStack.getTagCompound().hasKey("display", 10) && par1ItemStack.getTagCompound().getCompoundTag("display").hasKey("color", 3)));
    }
    ...
    {
        return this.material.func_151685_b() == par2ItemStack.getItem() || super.getIsRepairable(par1ItemStack, par2ItemStack);
    }
    ...
    public enum ArmorMaterial
    {
        ...
        ArmorMaterial(String par1Str, int par2, int par3, int[] par4ArrayOfInteger, int par5)
        {
