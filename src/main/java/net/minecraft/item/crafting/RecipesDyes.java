...
public class RecipesDyes
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        for (var2 = 0; var2 < 16; ++var2)
        {
            ...
            par1CraftingManager.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, BlockColored.func_150031_c(var2)), "###", "#X#", "###", '#', new ItemStack(Blocks.hardened_clay), 'X', new ItemStack(Items.dye, 1, var2));
            par1CraftingManager.addRecipe(new ItemStack(Blocks.stained_glass, 8, BlockColored.func_150031_c(var2)), "###", "#X#", "###", '#', new ItemStack(Blocks.glass), 'X', new ItemStack(Items.dye, 1, var2));
            par1CraftingManager.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, var2), "###", "###", '#', new ItemStack(Blocks.stained_glass, 1, var2));
        }
        ...
        for (var2 = 0; var2 < 16; ++var2)
        {
            par1CraftingManager.addRecipe(new ItemStack(Blocks.carpet, 3, var2), "##", '#', new ItemStack(Blocks.wool, 1, var2));
        }
    }
}
