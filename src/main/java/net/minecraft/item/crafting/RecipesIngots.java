...
public class RecipesIngots
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        par1CraftingManager.addRecipe(new ItemStack(Items.gold_ingot), "###", "###", "###", '#', Items.gold_nugget);
        par1CraftingManager.addRecipe(new ItemStack(Items.gold_nugget, 9), "#", '#', Items.gold_ingot);
    }
}
