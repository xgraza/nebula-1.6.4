...
public class Potion
{
    ...
    public static final Potion healthBoost = (new PotionHealthBoost(21, false, 16284963)).setPotionName("potion.healthBoost").setIconIndex(2, 2).func_111184_a(SharedMonsterAttributes.maxHealth, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, 0);
    ...
    public void performEffect(EntityLivingBase par1EntityLivingBase, int par2)
    {
        ...
        } else if (this.id == saturation.id && par1EntityLivingBase instanceof EntityPlayer)
        {
