...
public final class SpawnerAnimals
{
    ...
    private static ChunkPosition func_151350_a(World p_151350_0_, int p_151350_1_, int p_151350_2_)
    {
    ...
    public int findChunksForSpawning(WorldServer par1WorldServer, boolean par2, boolean par3, boolean par4)
    {
        ...
        } else
        {
            ...
            {
                player = par1WorldServer.playerEntities.get(0);
            }

            int var5;
            int var8;
            int countEntities;
            ChunkCoordIntPair var38;
            ...
            if (player == null || player.chunkCoordX != this.lastPlayerChunkX || player.chunkCoordZ != this.lastPlayerChunkZ || this.eligibleChunksForSpawning.size() <= 0)
            {
                ...
                {
                    EntityPlayer var34 = par1WorldServer.playerEntities.get(var5);
                    ...
                    for (int var37 = -var36; var37 <= var36; ++var37)
                    {
                        ...
                        {
                            boolean var39 = var37 == -var36 || var37 == var36 || countEntities == -var36 || countEntities == var36;
                            var38 = new ChunkCoordIntPair(var37 + var35, countEntities + var8);

                            if (!var39)
                            {
                                this.eligibleChunksForSpawning.put(var38, Boolean.valueOf(false));
                            } else if (!this.eligibleChunksForSpawning.containsKey(var38))
                            {
                                this.eligibleChunksForSpawning.put(var38, Boolean.valueOf(true));
                            }
                        }
                    }
                }
            ...
            for (int var43 = 0; var43 < var8; ++var43)
            {
                ...
                if ((!var44.getPeacefulCreature() || par3) && (var44.getPeacefulCreature() || par2) && (!var44.getAnimal() || par4) && countEntities <= var44.getMaxNumberOfCreature() * this.eligibleChunksForSpawning.size() / 256)
                {
                    ...
                    while (var46.hasNext())
                    {
                        var38 = (ChunkCoordIntPair) var46.next();

                        if (!((Boolean) this.eligibleChunksForSpawning.get(var38)).booleanValue())
                        {
                            Chunk chunk = par1WorldServer.getChunkFromChunkCoords(var38.chunkXPos, var38.chunkZPos);
                            int var14 = var38.chunkXPos * 16 + par1WorldServer.rand.nextInt(16);
                            int var16 = var38.chunkZPos * 16 + par1WorldServer.rand.nextInt(16);
