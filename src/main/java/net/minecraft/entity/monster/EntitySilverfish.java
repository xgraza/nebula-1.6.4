        ...
        if (!this.worldObj.isClient)
        {
            ...
            if (this.allySummonCooldown > 0)
            {
                ...
                if (this.allySummonCooldown == 0)
                {
                    ...
                    for (int var5 = 0; !var4 && var5 <= 5 && var5 >= -5; var5 = var5 <= 0 ? 1 - var5 : -var5)
                    {
                        for (var6 = 0; !var4 && var6 <= 10 && var6 >= -10; var6 = var6 <= 0 ? 1 - var6 : -var6)
                        {
                            for (int var7 = 0; !var4 && var7 <= 10 && var7 >= -10; var7 = var7 <= 0 ? 1 - var7 : -var7)
                            {
