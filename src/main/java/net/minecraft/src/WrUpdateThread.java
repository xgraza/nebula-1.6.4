...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread$ThreadUpdateListener updateListener = new WrUpdateThread$ThreadUpdateListener(this, (WrUpdateThread$1)null);
    ...
    static Tessellator access$000(WrUpdateThread x0)
    {
        return x0.mainTessellator;
    }

    static Tessellator access$100(WrUpdateThread x0)
    {
        return x0.threadTessellator;
    }

    static void access$300(WrUpdateThread x0, IWrUpdateControl x1)
    {
        x0.checkCanWork(x1);
    }
}
