...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass1136001858)null);
    ...
    static class NamelessClass1136001858
    {
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener
    {
        ...
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass1136001858)null);
        }
        ...
        ThreadUpdateListener(WrUpdateThread.NamelessClass1136001858 x1)
        {
            this();
        }
    }
    ...
    private class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        ThreadUpdateControl(WrUpdateThread.NamelessClass1136001858 x1)
        {
            this();
        }
    }
