...
public class ExpressionParser
{
    ...
    private IExpression parseExpression(Deque<Token> deque) throws ParseException
    {
        ...
        switch (ExpressionParser.NamelessClass232006122.$SwitchMap$net$optifine$entity$model$anim$TokenType[token.getType().ordinal()])
        {
            case 1:
    ...
    static class NamelessClass232006122
    {
