package us.nebula.client.impl.config;
...
public final class ClientSettingConfig implements IConfiguration
{
    ...
    public String save()
    {
        ...
        object.addProperty("verboseLogging", ClientSettings.VERBOSE_LOGGING);
    ...
    public void load(final String data)
    {
        ...
        ClientSettings.VERBOSE_LOGGING = object.has("verboseLogging")
                && object.get("verboseLogging").getAsBoolean();
