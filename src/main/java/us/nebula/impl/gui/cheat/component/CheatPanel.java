...
public final class CheatPanel extends GUIComponent implements IGUIInputListener
{
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        if (cheat.isToggled())
        {
            RenderUtil.roundedRectangle2D(x, y, width, height, 1.5f, new Color(112, 82, 143).getRGB());
        }
        ...
        if (cheat.getKey().getKeyCode() != KEY_NONE || listeningForKey)
        {
            ...
            RenderUtil.roundedRectangle2D((x + width) - textWidth - 21, y + 3, textWidth + (PADDING * 4), 9, 5f, new Color(33, 33, 33).getRGB());
