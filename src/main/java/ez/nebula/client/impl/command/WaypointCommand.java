        ...
        literal.then(literal("view")
                .then(argument("name", StringArgumentType.greedyString())
                        .executes((ctx) ->
                        {
                            ...
                            final Waypoint waypoint = Nebula.WAYPOINTS.get(serverIP, name);
                            if (waypoint == null)
                            {
                ...
                .then(literal("add")
                        .then(argument("name", StringArgumentType.string())
                                .executes((ctx) ->
                                {
                                    ...
                                    if (Nebula.WAYPOINTS.exists(serverIP, name))
                                    {
                                    ...
                                    Nebula.WAYPOINTS.register(waypoint);
                ...
                .then(literal("remove")
                        .then(argument("name", StringArgumentType.greedyString())
                                .executes((ctx) ->
                                {
                                    ...
                                    Nebula.WAYPOINTS.unregister(serverIP, name);
