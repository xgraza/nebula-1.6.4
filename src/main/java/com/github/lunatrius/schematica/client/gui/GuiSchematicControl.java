...
public class GuiSchematicControl extends GuiScreen
{
    ...
    public GuiSchematicControl(GuiScreen guiScreen)
    {
        ...
        this.schematic = Schematica.INSTANCE.getActiveSchematic();
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        drawCenteredString(this.fontRenderer, renderingLayer < 0 ? this.strAll : Integer.toString(renderingLayer + 1), this.width - 50, this.height - 145, 0xFFFFFF);
