...
public class SchematicWorld extends World
{
    ...
    public static ItemStack getIconFromName(String iconName)
    {
        ...
        icon = new ItemStack((Block) Block.blockRegistry.getObject(name), 1, damage);
    ...
    {
        return Block.getBlockById(getBlockIdRaw(x, y, z));
    }
    ...
    public boolean isSideSolid(int x, int y, int z, EnumFacing side, boolean _default)
    {
        ...
        return block.isBlockSolid(this, x, y, z, side.order_a);
    }
